...
plt.loglog(herm_grid, (10**-float(b1)*herm_grid**(float(m1)),'--',basex=10,basey=10,label='n^(-1.75)')
plt.loglog(herm_grid, (10**-float(b2)*herm_grid**(float(m2)),'--',basex=10,basey=10,label=('n^(%.4f)'% m))
plt.legend(loc='lower left')
plt.show()
## slope for E+ ~1.75
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~TESTING BLOCK~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
